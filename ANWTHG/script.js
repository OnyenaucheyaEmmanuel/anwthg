document
  ...
  document
    .getElementById("shareToWhatsAppButton")
    .addEventListener("click", function () {
      ...
      // Encode the data URL for WhatsApp sharing
      const encodedImageURL = encodeURIComponent(imageDataURL);

      // Create the WhatsApp share link
      const whatsappLink = `whatsapp://send?text=Check%20out%20this%20image&data=${encodedImageURL}`;
